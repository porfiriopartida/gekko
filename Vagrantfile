...
# All Vagrant configuratio`n is done below. The "2" in Vagrant.configure
...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
      ...
      echo "Running provision from Vagrantfile"
      echo "sudo add-apt-repository ppa:ubuntu-lxc/lxd-stable"
